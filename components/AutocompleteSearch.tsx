    ...
    <div className="relative w-full max-w-xl mx-auto">
      <div className="relative">
        <input
          ...
          className="w-full pl-12 pr-4 py-3 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl shadow-sm focus:outline-none focus:ring-2 focus:ring-primary transition-all"
        />
