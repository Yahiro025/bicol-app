/**
 * ECC Swift Build Resolver — Integrated into MetaBuff Ecosystem
 *
 * Source: ECC (affaan-m/ECC) agents/swift-build-resolver.md
 */

import { AgentDefinition } from './types/agent-definition'

const definition: AgentDefinition = {
  id: 'ecc-swift-build-resolver',
  version: '1.0.0',
  displayName: 'ECC Swift Build Resolver',
  spawnerPrompt: "Swift/Xcode build, compilation, and dependency error resolution specialist. Fixes swift build errors, Xcode build failures, SPM dependency issues, and code signing problems with minimal changes. Use when Swift builds fail.",
