/**
 * ECC Gan Evaluator — Integrated into MetaBuff Ecosystem
 *
 * Source: ECC (affaan-m/ECC) agents/gan-evaluator.md
 */

import { AgentDefinition } from './types/agent-definition'

const definition: AgentDefinition = {
  id: 'ecc-gan-evaluator',
  version: '1.0.0',
  displayName: 'ECC Gan Evaluator',
  spawnerPrompt: "\"GAN Harness — Evaluator agent. Tests the live running application via Playwright, scores against rubric, and provides actionable feedback to the Generator.\"",
  model: (() => {
    try {
  ...
  toolNames: ['read_files', 'write_file', 'run_terminal_command', 'code_search', 'find_files', 'spawn_agents', 'end_turn'],
  spawnableAgents: [],
