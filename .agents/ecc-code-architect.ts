/**
 * ECC Code Architect — Integrated into MetaBuff Ecosystem
 *
 * Source: ECC (affaan-m/ECC) agents/code-architect.md
 */

import { AgentDefinition } from './types/agent-definition'

const definition: AgentDefinition = {
  id: 'ecc-code-architect',
  version: '1.0.0',
  displayName: 'ECC Code Architect',
