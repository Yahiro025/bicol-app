/**
 * ECC Network Troubleshooter — Integrated into MetaBuff Ecosystem
 *
 * Source: ECC (affaan-m/ECC) agents/network-troubleshooter.md
 */

import { AgentDefinition } from './types/agent-definition'

const definition: AgentDefinition = {
  id: 'ecc-network-troubleshooter',
  version: '1.0.0',
  displayName: 'ECC Network Troubleshooter',
