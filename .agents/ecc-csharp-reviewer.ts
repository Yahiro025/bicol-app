/**
 * ECC Csharp Reviewer — Integrated into MetaBuff Ecosystem
 *
 * Source: ECC (affaan-m/ECC) agents/csharp-reviewer.md
 */

import { AgentDefinition } from './types/agent-definition'

const definition: AgentDefinition = {
  id: 'ecc-csharp-reviewer',
  version: '1.0.0',
  displayName: 'ECC Csharp Reviewer',
  spawnerPrompt: "Expert C# code reviewer specializing in .NET conventions, async patterns, security, nullable reference types, and performance. Use for all C# code changes. MUST BE USED for C# projects.",
