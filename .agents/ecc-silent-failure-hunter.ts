/**
 * ECC Silent Failure Hunter — Integrated into MetaBuff Ecosystem
 *
 * Source: ECC (affaan-m/ECC) agents/silent-failure-hunter.md
 */

import { AgentDefinition } from './types/agent-definition'

const definition: AgentDefinition = {
  id: 'ecc-silent-failure-hunter',
  version: '1.0.0',
  displayName: 'ECC Silent Failure Hunter',
  spawnerPrompt: "Review code for silent failures, swallowed errors, bad fallbacks, and missing error propagation.",
  model: (() => {
    try {
