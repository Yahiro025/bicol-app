/**
 * ECC Chief Of Staff — Integrated into MetaBuff Ecosystem
 *
 * Source: ECC (affaan-m/ECC) agents/chief-of-staff.md
 */

import { AgentDefinition } from './types/agent-definition'

const definition: AgentDefinition = {
  id: 'ecc-chief-of-staff',
  version: '1.0.0',
  ...
  toolNames: ['read_files', 'code_searcher', 'glob', 'basher', 'str_replace', 'write_file', 'spawn_agents'],
  spawnableAgents: [],
