/**
 * ECC Gan Generator — Integrated into MetaBuff Ecosystem
 *
 * Source: ECC (affaan-m/ECC) agents/gan-generator.md
 */

import { AgentDefinition } from './types/agent-definition'

const definition: AgentDefinition = {
  id: 'ecc-gan-generator',
  version: '1.0.0',
  displayName: 'ECC Gan Generator',
  spawnerPrompt: "\"GAN Harness — Generator agent. Implements features according to the spec, reads evaluator feedback, and iterates until quality threshold is met.\"",
  model: (() => {
    try {
