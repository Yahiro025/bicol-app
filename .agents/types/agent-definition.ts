...
export interface AgentDefinition {
  ...
  /**
   * Optional AI model for this agent. When omitted, the host runtime selects
   * the active/request model, making the agent portable across providers and
   * model families. Set this only when the agent requires a fixed model.
   * Any model in OpenRouter is supported: https://openrouter.ai/models
   */
  model?: ModelName
