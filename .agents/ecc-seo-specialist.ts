/**
 * ECC Seo Specialist — Integrated into MetaBuff Ecosystem
 *
 * Source: ECC (affaan-m/ECC) agents/seo-specialist.md
 */

import { AgentDefinition } from './types/agent-definition'

const definition: AgentDefinition = {
  id: 'ecc-seo-specialist',
  version: '1.0.0',
  displayName: 'ECC Seo Specialist',
  spawnerPrompt: "SEO specialist for technical SEO audits, on-page optimization, structured data, Core Web Vitals, and content/keyword mapping. Use for site audits, meta tag reviews, schema markup, sitemap and robots issues, and SEO remediation plans.",
  model: (() => {
    try {
  ...
  toolNames: ['read_files', 'code_search', 'find_files', 'web_search', 'spawn_agents', 'end_turn'],
  spawnableAgents: [],
