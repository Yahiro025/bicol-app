/**
 * ECC Comment Analyzer — Integrated into MetaBuff Ecosystem
 *
 * Source: ECC (affaan-m/ECC) agents/comment-analyzer.md
 */

import { AgentDefinition } from './types/agent-definition'

const definition: AgentDefinition = {
  id: 'ecc-comment-analyzer',
  version: '1.0.0',
  displayName: 'ECC Comment Analyzer',
  spawnerPrompt: "Analyze code comments for accuracy, completeness, maintainability, and comment rot risk.",
