/**
 * ECC Cpp Build Resolver — Integrated into MetaBuff Ecosystem
 *
 * Source: ECC (affaan-m/ECC) agents/cpp-build-resolver.md
 */

import { AgentDefinition } from './types/agent-definition'

const definition: AgentDefinition = {
  id: 'ecc-cpp-build-resolver',
  version: '1.0.0',
  displayName: 'ECC Cpp Build Resolver',
  spawnerPrompt: "C++ build, CMake, and compilation error resolution specialist. Fixes build errors, linker issues, and template errors with minimal changes. Use when C++ builds fail.",
