/**
 * ECC Fsharp Reviewer — Integrated into MetaBuff Ecosystem
 *
 * Source: ECC (affaan-m/ECC) agents/fsharp-reviewer.md
 */

import { AgentDefinition } from './types/agent-definition'

const definition: AgentDefinition = {
  id: 'ecc-fsharp-reviewer',
  version: '1.0.0',
  displayName: 'ECC Fsharp Reviewer',
  spawnerPrompt: "Expert F# code reviewer specializing in functional idioms, type safety, pattern matching, computation expressions, and performance. Use for all F# code changes. MUST BE USED for F# projects.",
  model: (() => {
    try {
