import { 
  ...
  Theater, Church, Hammer, Car, Soup, Seedling, Cube, Gavel, 
...
export const CATEGORY_META: Record<string, CategoryMeta> = {
  ...
  "Environment": { icon: Seedling, color: "#40407A" },
  "Object": { icon: Cube, color: "#636E72" },
  ...
  "Animals & Nature": { icon: Seedling, color: "#00B894" },
