/**
 * ECC Django Build Resolver — Integrated into MetaBuff Ecosystem
 *
 * Source: ECC (affaan-m/ECC) agents/django-build-resolver.md
 */

import { AgentDefinition } from './types/agent-definition'

const definition: AgentDefinition = {
  id: 'ecc-django-build-resolver',
  version: '1.0.0',
  displayName: 'ECC Django Build Resolver',
