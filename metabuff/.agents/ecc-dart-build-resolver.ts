/**
 * ECC Dart Build Resolver — Integrated into MetaBuff Ecosystem
 *
 * Source: ECC (affaan-m/ECC) agents/dart-build-resolver.md
 */

import { AgentDefinition } from './types/agent-definition'

const definition: AgentDefinition = {
  id: 'ecc-dart-build-resolver',
  version: '1.0.0',
  displayName: 'ECC Dart Build Resolver',
  spawnerPrompt: "Dart/Flutter build, analysis, and dependency error resolution specialist. Fixes `dart analyze` errors, Flutter compilation failures, pub dependency conflicts, and build_runner issues with minimal, surgical changes. Use when Dart/Flutter builds fail.",
