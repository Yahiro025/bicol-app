...
Before modifying UI:
1. **Divergent Design:** Propose 2-3 visual approaches (e.g., Grid vs. List, Minimalist vs. Informational).
2. **Red-Teaming:** Check each for accessibility (WCAG AA), responsiveness, and "Response Elevation" violations.
3. **Convergent Implementation:** Use the **Split-Step Protocol** (Verify elements exist -> Apply changes).
